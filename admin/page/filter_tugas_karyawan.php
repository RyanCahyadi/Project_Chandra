      	...
      	<div class="container-fluid">
			<div class="row">
		    	...
		    	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    				...
    				<!-- Modal -->
    				<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-karyawan"><span class="glyphicon glyphicon-plus"></span>Tambah Laporan Tugas Karyawan</button><br /><br />
                    <label>Filter</label>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="proses.php?page=filter-laporan-karyawan&&id=<?= $row['id']; ?>" method="POST">
    				...
    				<table class="table table-hover table-responsive" id="datatables-lapkaryawan">
    					...
    					<tbody>
    						<?php 
    						$no 	= 1;
						    $sql 	= mysql_query("SELECT * FROM tbl_laporank WHERE tgl_tugas BETWEEN '$from' AND '$to'");
    					...
    					<tr>
    						...
    						<td>
    							...
    							<a href="" onclick="window.open('detail/laporan_karyawan.php?id=<?= $row['id']; ?>').print();"><span class="glyphicon glyphicon-exclamation-sign"></span></a>
    						</td>
    					</tr>
    					<?php } ?>
    					</tbody>
