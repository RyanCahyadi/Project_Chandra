      	...
      	<div class="container-fluid">
			<div class="row">
    			...
    			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    				<h2>Update Data Surat Karyawan</h2>
    				  <form action="proses.php?page=edit-surat-karyawan" method="POST" enctype="multipart/form-data">
    					...
    					<div class="form-group">
    						...
    						<input type="number" name="no-surat" class="form-control" value="<?= $row['no_surat']; ?>">
    					</div>
    					<div class="form-group">
